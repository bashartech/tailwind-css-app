  ...
  return (
    <div className="main  w-screen" id="services">
      ...
      <div className="section sm:w-[450px] lg:mt-5 lg:w-full lg:p-15 lg:flex gap-5 justify-center items-center">
        ...
        <div className="box2 hover:h-[405px] hover:lg:w-[302px] flex justify-center items-center rounded-xl bg-gray-800 mt-5 w-[350px] lg:w-[300px] h-[400px] border-2 border-white">
            <div className="content p-5 ">
...
<button className="border-2 border-white p-1 rounded-lg hover:bg-gray-700">Get Started</button>
        ...
        <div className="box3 hover:h-[405px] hover:lg:w-[302px] flex justify-center items-center rounded-xl bg-gray-800 mt-5 w-[350px] lg:w-[300px] h-[400px]  border-2 border-white">
            <div className="content p-5 ">
